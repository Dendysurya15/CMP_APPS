...
class ListTPHFromQRActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val TAG = "ListTPHFromQRActivity"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupRecyclerView()
        processQRResult()
        val flCheckBoxTableHeaderLayout = findViewById<FrameLayout>(R.id.flCheckBoxTableHeaderLayout)
...
//        val filterSection = findViewById<LinearLayout>(R.id.filterSection)
                    ...
                    try {
                        ...
                        result.fold(
                            onSuccess = { savedIds ->
                                ...
                                Toasty.success(this@ListTPHFromQRActivity, "Data berhasil disimpan", Toast.LENGTH_LONG, true).show()
                                startActivity(Intent(this@ListTPHFromQRActivity, HomePageActivity::class.java))
                                finish()
                            },
                            onFailure = { exception ->
    ...
    private suspend fun parseTphData(jsonString: String): List<TphRvData> = withContext(Dispatchers.IO) {
        try {
