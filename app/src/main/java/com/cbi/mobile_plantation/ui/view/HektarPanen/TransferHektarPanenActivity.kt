...
class TransferHektarPanenActivity : AppCompatActivity() {
    ...
    private fun setupUI() {
        ...
        viewModel.loadHistoryESPBNonScan(AppUtils.currentDate)
    }
    ...
    private fun processSelectedDate(selectedDate: String) {
        ...
        viewModel.loadHistoryESPBNonScan(selectedDate)
        ...
        removeFilterDate.setOnClickListener {
            ...
            viewModel.loadHistoryESPBNonScan(todayBackendDate)
        }
    ...
    private fun setupObserveData() {
        viewModel.historyESPBNonScan.observe(this) { data ->
                                ...
                                async {
                                    ...
                                    val blokData = try {
                                        withContext(Dispatchers.IO) {
                                            viewModel.getBlokById(idBlokList)
                                        }
                                    } catch (e: Exception) {
    ...
    private fun initViewModel() {
        ...
        viewModel = ViewModelProvider(this, factory)[ESPBViewModel::class.java]
    }
    ...
    private fun setupFilterAllData() {
        ...
        filterAllData.setOnCheckedChangeListener { _, isChecked ->
            if (isChecked) {
                ...
                viewModel.loadHistoryESPBNonScan(null)  // Pass null to load all data
            } else {
                ...
                viewModel.loadHistoryESPBNonScan(globalFormattedDate)
            }
